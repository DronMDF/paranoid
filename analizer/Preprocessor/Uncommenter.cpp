...
void Uncommenter::parse(const std::shared_ptr<const Line> &line)
{
...
void Uncommenter::scanText(const shared_ptr<LineUncommented> &line, unsigned offset)
{
...
void Uncommenter::scanString(const shared_ptr<LineUncommented> &line, 
...
void Uncommenter::scanChar(const shared_ptr<LineUncommented> &line, unsigned offset)
{
	const auto pos = line->getText().find_first_of("\\'", offset);
	if (pos == string::npos) {
...
void Uncommenter::scanComment(const shared_ptr<LineUncommented> &line, unsigned offset)
{
	const auto pos = line->getText().find_first_of("/*", offset);
	if (pos == string::npos) {
...
void Uncommenter::scanCppComment(const shared_ptr<LineUncommented> &line, unsigned offset)
{
	line->hide(offset - 2, string::npos);
}

void Uncommenter::scanCComment(const shared_ptr<LineUncommented> &line, unsigned offset)
{
